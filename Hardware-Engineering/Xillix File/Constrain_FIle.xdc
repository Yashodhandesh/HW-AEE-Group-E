...
# Override clock routing constraint for Equals_IBUF
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets Equals_IBUF];
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { Equals }]; #IO_L9P_T1_DQS_14 Sch=btnc
